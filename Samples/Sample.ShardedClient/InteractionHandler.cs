...
public class InteractionHandler : DiscordShardedClientService
{
    ...
    public InteractionHandler(DiscordShardedClient client, ILogger<InteractionHandler> logger, InteractionService handler, IServiceProvider provider) : base(client, logger)
    {
        _handler = handler;
        _provider = provider;
    }
